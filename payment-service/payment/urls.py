...
urlpatterns = [
    ...
    path('<uuid:order_id>/', views.PaymentQueryByOrderAPIView.as_view(), name='payment-query-by-order'),  # GET /api/payment/{order_id}/
    ...
    path('<uuid:order_id>/refund/', views.PaymentRefundAPIView.as_view(), name='payment-refund'),  # POST /api/payment/{order_id}/refund/
]
