...
if BASE_DIR.startswith('/app'):
    # Docker 容器环境：/app/notification/views.py -> BASE_DIR=/app -> PARENT_DIR=/app
    PARENT_DIR = BASE_DIR
else:
    # 本地开发环境：D:\CFMP-order\notification-service\notification\views.py -> BASE_DIR=D:\CFMP-order\notification-service -> PARENT_DIR=D:\CFMP-order
